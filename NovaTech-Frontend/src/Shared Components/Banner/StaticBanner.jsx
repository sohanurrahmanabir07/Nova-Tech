...
export const StaticBanner = ({BannerImg}) => {
  return (
    <div className='relative flex items-center justify-center rounded-lg max-w-[1440px] max-sm:px-5 md:px-10 m-auto '>

        <img src={BannerImg || Banner} className=' w-full overflow-hidden rounded-lg md:aspect-4/2' alt="" />
