                ...
                banners.map((item, index) => (
                  <div key={index} className="bg-transparent">
                    <div className="slide-content mx-2 rounded-xl space-y-10 relative    transition duration-300">
                      <img src={item.imageUrl[0] || 'https://res.cloudinary.com/des05ruq7/image/upload/v1748695524/vi3mxypffpliytvhk9lz.jpg'} className="w-full rounded-xl md:h-[450px]" alt="" />
                      <div>
