        ...
        !item ?
          ...
          (
            <div className='relative overflow-hidden rounded-lg shadow-sm shadow-gray-400'>
              ...
              <img src={` ${item?.imageUrl || `https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/Image_not_available.png/800px-Image_not_available.png?20210219185637`} `} className='md:max-h-[400px] w-full aspect-3/2 md:aspect-square' alt="" />
